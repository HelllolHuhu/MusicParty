...
export const TRANSLATIONS = {
  ...
  es: {
    ...
    "creator.part.head_3": "Ovalada / Corazón",
    "creator.part.hair_none": "Calvo",
    "creator.part.hair_1": "Tupé / Puntiagudo",
    "creator.part.hair_2": "Afro / Rizos",
    "creator.part.hair_3": "Cresta / Punk",
    "creator.part.eyes_1": "Clásicos",
    "creator.part.eyes_2": "Relajados",
    "creator.part.eyes_3": "Brillantes (Anime)",
    ...
    "lobby.enterRoomError": "¡Por favor ingresa el código de la sala!",
    "lobby.roomNotFound": "¡La sala no existe!",
    "lobby.roomFull": "¡La sala está llena!",
    "lobby.kickedAlert": "¡Has sido expulsado de la sala!",
    "lobby.need2Players": "¡Se necesitan al menos 2 jugadores para iniciar!",
    ...
    "playerList.kickConfirm": "¿Seguro que quieres expulsar a este jugador?",
    "playerList.emptySlot": "Espacio libre...",

    // Lobby Settings
    "settings.title": "Ajustes de Juego",
    ...
    "game.partyVibes": "120 BPM • Fiesta",
    "game.letsGo": "¡Vamos!",
